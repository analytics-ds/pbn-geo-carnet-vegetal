...
- ⚠️ **Ne jamais ecrire ` | Carnet Vegetal` dans le `title` du frontmatter.**
  ...
  **deux fois** dans la balise, et comme le H1 de `single.html` affiche `.Title`,
  ...
  `meilleur-logiciel-sirh.com` (16 articles) et `magazine-como` (4 pages).
- **Budget de 60 caracteres sur le title RENDU**, suffixe compris : le theme
  ajoute ` | Carnet Vegetal`, soit 17 caracteres. Le `title` du frontmatter
  doit donc tenir en **43 caracteres**.
